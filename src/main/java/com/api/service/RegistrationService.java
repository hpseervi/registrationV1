...
public class RegistrationService {
    ...
    public RegistrationDto createRegistration(RegistrationDto registrationDto) {
        //copy dto to entity
        Registration registration = mapToEntity(registrationDto); //method called using 'this' keyword
        Registration savedEntity = registrationRepository.save(registration);

        //copy entity to dto
        RegistrationDto dto = mapToDto(savedEntity); //method called using 'this' keyword
        return dto;
    }
...
//        dto.setMobile(registration.getMobile());
    ...
    public RegistrationDto getRegById(long id) {
        Registration registration = registrationRepository.findById(id).orElseThrow(
                ()->new ResourceNotFoundException("Record is not available in database")
        );
